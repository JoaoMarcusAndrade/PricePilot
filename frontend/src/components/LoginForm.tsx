...
export default function LoginForm({ onGoogle, onToggle }: Props) {
  ...
  async function handleSubmit(onSubmit: (email: string, password: string) => Promise<{ error: string | null }>) {
    setError(null);
